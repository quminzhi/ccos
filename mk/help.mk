...
help:
	...
	@echo "  opensbi       Build OpenSBI fw_jump"
	@echo "  docker-opensbi Build OpenSBI via Docker"
	@echo "  clean         Remove kernel build artifacts"
	@echo "  clean-opensbi Clean OpenSBI build directory"
	@echo "  distclean     Clean kernel + OpenSBI"
	@echo ""
	...
	@echo "  OPENSBI_CROSS_COMPILE=<prefix> OpenSBI toolchain prefix"
